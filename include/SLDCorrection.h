...
private:
	...
	float					m_BSLD4SigmaAlpha = 0.0;
	float					m_BSLD5SigmaTheta = 0;
	float					m_BSLD5SigmaPhi = 0;
	float					m_BSLD5SigmaAlpha = 0.0;
	...
	DoubleVector				m_recoNeutralTheta{};
	DoubleVector				m_recoNeutralPhi{};
	...
	DoubleVector				m_recoChargedTheta{};
	DoubleVector				m_recoChargedPhi{};
	...
	DoubleVector				m_cheatedPVARecoNeutralTheta{};
	DoubleVector				m_cheatedPVARecoNeutralPhi{};
	...
	DoubleVector				m_cheatedPVARecoChargedTheta{};
	DoubleVector				m_cheatedPVARecoChargedPhi{};
	...
	DoubleVector				m_visiblePxCheatedPVA{};
	DoubleVector				m_visiblePyCheatedPVA{};
	DoubleVector				m_visiblePzCheatedPVA{};
	DoubleVector				m_visibleEnergyCheatedPVA{};
	DoubleVector				m_visibleMassCheatedPVA{};
